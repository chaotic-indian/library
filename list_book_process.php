...
if(confirm("Are you ready to edit this Author? ")){
return true;
}
else{
return false;
            ...
            <?php 
echo '<a href="list_book_process.php?lett=a&letter=A">A</a>&nbsp;&nbsp; 
<a href="list_book_process.php?lett=b&letter=B">B</a> &nbsp;&nbsp;&nbsp; 
<a href="list_book_process.php?lett=c&letter=C">C</a>&nbsp;&nbsp;&nbsp; 
<a href="list_book_process.php?lett=d&letter=D">D</a>&nbsp;&nbsp;&nbsp; 
<a href="list_book_process.php?lett=e&letter=E">E</a>&nbsp;&nbsp;&nbsp;
 <a href="list_book_process.php?lett=f&letter=F">F</a>&nbsp;&nbsp;&nbsp;
...
<a href="list_book_process.php?lett=k&letter=K">K</a>&nbsp;&nbsp;&nbsp;
...
echo "<tr><td width=50>SERIAL</td><td>TITLE</td><td width=70>ISBN</td><td width=60>ACTION1</td><td width=60>ACTION2</td></tr>";
...
if 	($title[0]==$test || $title[0] == $test2){
 echo "<tr><td>$sn</td><td>$title</td><td>$isbn</td><td><form  action=edit_book.php><input type=hidden name=id value=$book_id><input type=submit value=Edit ></form></td><td><form  action=delete_book.php onSubmit=return(readySubmit())><input type=hidden name=id value=$book_id><input type=submit value=Delete ></form></td></tr>";
 $sn++;
}
