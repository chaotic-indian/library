...
<div class="top">
    ...
    <div class="menu"><a href="index.php">HOME</a></div>
	    <div class="menu"><a href="library.php">THE LIBRARY</a></div>   
    <div class="menu"><a href="about.php">ABOUT</a></div>
    <div class="menu"><a href="search_form2.php">SEARCH/DOWNLOAD</a></div>
    ...
    <p align="right" style="padding-right:10px">
        ...
        if (isset($_SESSION['user_log'])){
            ...
            echo "<a href='login.php' style='color:#FFC'>Sign In for users</a>";
