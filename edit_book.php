...
?>
          <form action="update_book_detail_process2.php" method="post" name="form1" id="form1">
...
<tr>
              ...
              <tr>
                <td>&nbsp;</td>
                <td><input type="submit" name="Submit" value="Update" onclick="confirm(Are you sure you want to edit this title? )" /></td>
              </tr>
            </table>
  </form>
          <p>
